...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private static final String EXPECTED_CATEGORY_NOT_FOUND = "Expected Category Not Found";
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        log.debug("Retrieving Units of Measure");
        UnitOfMeasure eachUom = unitOfMeasureRepository.findByDescription("Each")
                .orElseThrow(() -> new RuntimeException(EXPECTED_UOM_NOT_FOUND));
        ...
        Category americanCategory = categoryRepository.findByDescription("American")
                .orElseThrow(() -> new RuntimeException(EXPECTED_CATEGORY_NOT_FOUND));
